...
Basándote en el SRTM-DEM de 1 arcosegundo, construye un DEM para tu polígono asignado usando QGIS
...
# ID de Poligono
poligonos_sf$id <- paste0('data/practica-04/poligono_', 1:nrow(poligonos_sf), '.kml')
...
3. Muestra, en una captura de pantalla dentro de tu entregable, tus dos DEM de forma independiente, simbolizados como prefieras.

4. En QGIS, construye un mosaico mediante ráster virtual (`.vrt`). 

5. Muestra, en una captura de pantalla dentro de tu entregable, tu mosaico de DEM, simbolizado como prefieras.
